...
<%
		...
		//here gid is retrieved through session from f_chat1.jsp
				request.getSession();
				String gid=(String)session.getAttribute("groupid");

		//here username is retrieved through session from f_home.jsp
				request.getSession();
		...
		try {
			...
			if(r!=0)
			{
				...
				response.sendRedirect("f_chat1.jsp?gid="+gid);
			}
			else{
