			...
			function sendInfo(str) 
			{
			    if (str.length == 0) 
			    ...
			    else 
			     {
			        ...
			        var str=document.f1.academicyear.value;
			        obj.onreadystatechange = getInfo;
			        try
				        {
				        obj.open("GET", "search_recordsdb.jsp?q=" + str, true);
				        obj.send();
				        }
			        catch(e)
			        	{
...
<div id="wrapper">
	...
	<div id="page">
		<div id="content">
		<div class="post">
                    	<h2 class="title">Search Student Records</h2>
    			...
    			<h3>Search</h3>
               		<form name="f1" action="search_recordsdb.jsp" method="post">
   		  					<table>
		  						<tr>
				  					<td>Academic Year:</td> <td><input type="text" name="academicyear" onkeyup="sendInfo(this.value)" placeholder="20XX_20XX"></td>
									<div id=d1></div>
								</tr>		
							</table>	
						</form>
