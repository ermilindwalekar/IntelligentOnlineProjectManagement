...
<div id="wrapper">
	...
	<div id="page">
		<div id="content">
		<div class="post">
                    <h2>Post Request</h2><br></div><br><br>
    ...
    <% for(getset obj : a2){%>
      ...
      <b>Name:</b>   &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%out.println(obj.getUsername());%><br><br>
      <b>Academic Year:</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%out.println(obj.getAcadmic());%><br><br>
      <b>Stream:</b>   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%out.println(obj.getStream());%><br><br>
      <b>Department:</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%out.println(obj.getDepartment());}%><br><br>
		...
		<!-- end #content -->
                <div id="sidebar"><br><br><br>
                        ...
                        <ul><br><br><br><br>
                         ...
                         <h2>Request</h2>
                            <li>
                                &nbsp;	<a href="student.jsp">Post Request</a><br>
                            &nbsp;&nbsp;<a href="upload.jsp">Upload Document</a><br>
                              &nbsp;&nbsp;<a href="view_status.jsp">View Status</a><br>
                            &nbsp;&nbsp;<a href="s_lognote.jsp">LogNotes</a><br></li>
            				&nbsp;&nbsp;<a href="s_chat1.jsp">Chat</a><br></li>                             
            				&nbsp;&nbsp;<a href="s_home.jsp">Home</a><br></li>                               
...
<div id="footer">
   ...
   <%! 
    ...
    public void setAcadmic(String acadmic_year) {
...
private ArrayList<getset> searching2(String uid) {
     ...
     try{
        ...
        try {
            ...
            String query3 ="SELECT userid,name,academic_year,stream,department from detail where userid='"+uid+"' ";
       ...
       obj.setUsername((rs.getString(2)));
         obj.setAcadmic((rs.getString(3)));
         
         obj.setStream((rs.getString(4)));
         obj.setDepartment((rs.getString(5)));
