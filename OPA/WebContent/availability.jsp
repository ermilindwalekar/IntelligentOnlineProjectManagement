 ...
 function sendInfo(str) 
	{
	    if (str.length == 0) 
	    ...
	    else 
	     {
	        ...
	        var str=document.f1.year.value;
	        obj.onreadystatechange = getInfo;
	        try
		        {
		        obj.open("GET", "availability_db.jsp?q=" + str, true);
		        obj.send();
		        }
	        catch(e)
	        	{
...
<div id="wrapper">
	...
	<div id="page">
		<div id="content">
			<div class="post">
				<h2 class="title">Guide Availability</h2>
					<div style="clear: both;">&nbsp;</div>
					
			</div>
						<form name="f1" action="availability_db.jsp" method="post">
					Enter Year: <input type="text" name="year" onkeyup="sendInfo(this.value)" placeholder="3 or 4"> 
					<div id=d1></div>
				</form>
