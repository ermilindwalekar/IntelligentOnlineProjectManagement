...
// This function will validate Name.  
  ...
  document.myform.academic.focus();  
  return true;  
  }  
  else  
  {  
		...
		<center>
		   <fieldset>	
		     <legend><h1>Registration Page 1</h1></legend>
		  	  <form name="myform" action="s_regdb1.jsp" method="post">
                              &nbsp; &nbsp; &nbsp;<table>
		  			<tr>
					...
					<tr>	
						<td>ACADEMIC YEAR :</td> 
							<td><select name="academic" onblur="Academic()">
  								<option value="2015_2018">2015-2018</option>
  								<option value="2016_2020">2016-2020</option>
  								<option value="2017_2021">2017-2021</option>
  								<option value="2018_2022">2018-2022</option>
							</select></td>
					</tr>
					<tr>
						<td>STREAM :</td> 
					...
					<tr>
						<td>SECTION :</td> 
							<td><select name="section" onblur="Section()">
					...
					<tr>
						<td>YEAR :</td> 
							<td><select name="year" onblur="Year()">
								<option value="3">3</option>
								<option value="4">4</option>
							</select></td>
					</tr>
					...
					<tr>
						<td>MOBILE NO. :</td> <td><input type="text" name="mobno" onblur="validate()" required></td><span id="numloc"></td>
					</tr>
					<tr>
