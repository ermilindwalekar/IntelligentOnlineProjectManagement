...
<div id="wrapper">
	...
	<div id="page">
		<div id="content">
			<div class="post">
				<h2 class="title">Post Request :</h2>
		...
		try {
					...
					PreparedStatement pst=con.prepareStatement("select name from detail where userid=?");
					pst.setString(1,uid);
					...
					if(rs.next()){
						...
						//here session is transferred to s_chat2.jsp 
				     	
				     	session=request.getSession();
						session.setAttribute("s_name", name); 
						%>
                                                <h3>Welcome: <%=name%></h3><br><br>
						<fieldset>
						...
						<form action="postreq" method="post" name="f1" >
                                                    
							<tr><td>Project Title:</td> <td><input type="text" name="title"></td></tr>
							<tr><td><input type="submit" value="Post Request" onClick='check(this.value)'></td></tr>
                                            ...
                                            {
                                            %>
                                            <br><br>  &nbsp;&nbsp;    <span1 class="red" >Project Title Has Been Selected Successfully !!!</span1>
                                            <%}%>
                                                     <%
                                            if(request.getAttribute("errorMessage7")!=null)
                                            {
                                            %>
                                            <br><br>  &nbsp;&nbsp;    <span1 class="red" >You Can Choose Project Title Only Once !!!</span1>
                                            <%}%>
                                              		<%
                                            if(request.getAttribute("errorMsg")!=null)
                                            {
                                            %> 
                                            <br><br>  &nbsp;&nbsp;    <span1 class="red" >Sorry This Project Title Has Already Been Selected By Another Group !!!</span1>
                                            <%}%> 
