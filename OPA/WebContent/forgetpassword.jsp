		...
		<center>
		  	  ...
		  	  <form action="forget" method="post">
		  		<table>
                                    ...
                                    <br>
                                        <tr>
                                            <td>Enter UserId:</td><td><input type="text"  name="uid" required>
                                        </tr>
					<tr>	
						<td>Hint Question :</td>
					...
					<tr>
						<td>Answer :</td>  <td><input type="text" name="answer" required>
							
					</tr>
					
					<tr>
                                            <td><br><input type="submit" value="SUBMIT"> </td><td><br><input type="reset" value="RESET"></td>
		  	  		</tr>
		  	  	</table>
		  	  </form>
		   </fieldset>	
                                 ...
                                 <%
                                            ...
                                            {
                                            %>
                                           <span1 class="red" >Entered Wrong Entries !!!</span1>
                                            <%}%>
                                         <%
                                            if(request.getAttribute("errorMessage1")!=null)
                                            {
                                            %>
                                           <span1 class="red" >Internet Problem!!!</span1>
                                            <%}%>
                                         <%
                                            if(request.getAttribute("errorMessage2")!=null)
                                            {
                                            %>
                                         <span1 class="red" >Check Out Your Email !!!</span1>
                                            <%}%>
        </div></div>
