...
<div id="wrapper">
	...
	<div id="page">
		<div id="content">
			<div class="post">
				<h2 class="title">Status/Comments :</h2>
			...
			//session (GROUPID) is retrieved here from login.jsp	
		...
		try {
					...
					PreparedStatement pst=con.prepareStatement("select gid,document_type,status,f_comment from project_details where inc= (select max(inc) from project_details where gid=?)");     
					pst.setString(1,gid);
					...
					if(rs.next())
					    {   %>
                                            <h3>UserID :&nbsp;&nbsp;&nbsp; <%=uid%></h3><br><br>	
                                            <fieldset>
                                                <legend><h3>Status/Comments</h3></legend>
