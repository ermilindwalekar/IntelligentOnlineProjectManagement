...
<body onload="first()">
    <script>
        function first(){
            document.myform1.gid3_1.focus();
        }
        function Gid3_1(){
            var gd=document.myform1.gid3_1;
            var patt=/^[G][CS|IT]{2}[1-4]{1}[3|4]{1}[0-8]{2}$/;
            if(gd.value.match(patt)){
                document.myform1.gid3_2.focus();
                return true;
            }
            else{
        ...
        function Gid3_2(){
            var gd=document.myform1.gid3_2;
            var patt=/^[G][CS|IT]{2}[1-4]{1}[3|4]{1}[0-8]{2}$/;
            if(gd.value.match(patt)){
                document.myform1.gid3_3.focus();
                return true;
            }
            else{
                alert("Enter valid Group ID");
        ...
        function Gid3_3(){
            var gd=document.myform1.gid3_3;
            var patt=/^[G][CS|IT]{2}[1-4]{1}[3|4]{1}[0-8]{2}$/;
            if(gd.value.match(patt)){
                document.myform1.gid3_4.focus();
                return true;
            }
            else{
                alert("Enter valid Group ID");
        ...
        function Gid3_4(){
            var gd=document.myform1.gid3_4;
            var patt=/^[G][CS|IT]{2}[1-4]{1}[3|4]{1}[0-8]{2}$/;
            if(gd.value.match(patt)){
                document.myform1.gid4_1.focus();
                return true;
            }
            else{
                alert("Enter valid Group ID");
        ...
        function Gid4_1(){
            var gd=document.myform1.gid4_1;
            var patt=/^[G][CS|IT]{2}[1-4]{1}[3|4]{1}[0-8]{2}$/;
            if(gd.value.match(patt)){
                document.myform1.gid4_2.focus();
                return true;
            }
            else{
                alert("Enter valid Group ID");
        ...
        function Gid4_2(){
            var gd=document.myform1.gid4_2;
            var patt=/^[G][CS|IT]{2}[1-4]{1}[3|4]{1}[0-8]{2}$/;
            if(gd.value.match(patt)){
                document.myform1.gid4_3.focus();
                return true;
            }
            else{
                alert("Enter valid Group ID");
        ...
        function Gid4_3(){
            var gd=document.myform1.gid4_3;
            var patt=/^[G][CS|IT]{2}[1-4]{1}[3|4]{1}[0-8]{2}$/;
            if(gd.value.match(patt)){
                document.myform1.gid4_4.focus();
                return true;
            }
            else{
                alert("Enter valid Group ID");
        ...
        function Gid4_4(){
            var gd=document.myform1.gid4_4;
            var patt=/^[G][CS|IT]{2}[1-4]{1}[3|4]{1}[0-8]{2}$/;
            if(gd.value.match(patt)){
		...
		<div id="content">
			<div class="post">
				...
				<div style="clear: both;">&nbsp;</div>
				 ...
				 <%
                                            if(request.getAttribute("errorMessage9")!=null)
                                            {
                                            %>
		...
		<center>
		   <fieldset>	
		     <legend><h1>Registration Page 2</h1></legend>
		  	  <form name="myform1" action="f_regdb2.jsp" method="post">
		  		<table>
		  			<tr>
						<td>GROUP_ID 1:</td> <td><input type="text" name="gid3_1" placeholder="3rd Year" onblur="Gid3_1()" required> <input type="text" name="gid4_1" placeholder="4th Year" onblur="Gid4_1()" required></td>
					</tr>
		  			<tr>
						<td>GROUP_ID 2:</td> <td><input type="text" name="gid3_2" placeholder="3rd Year" onblur="Gid3_2()" required> <input type="text" name="gid4_2" placeholder="4th Year" onblur="Gid4_2()" required></td>
					</tr>
		  			<tr>
						<td>GROUP_ID 3:</td> <td><input type="text" name="gid3_3" placeholder="3rd Year" onblur="Gid3_3()" required> <input type="text" name="gid4_3" placeholder="4th Year" onblur="Gid4_3()" required></td>
					</tr>
		  			<tr>
						<td>GROUP_ID 4:</td> <td><input type="text" name="gid3_4" placeholder="3rd Year" onblur="Gid3_4()" required> <input type="text" name="gid4_4" placeholder="4th Year" onblur="Gid4_4()" required></td>
					</tr>
		  			<tr>
