	...
	<div id="page">
		...
		try {
					...
					if(rs.next()){
						...
						<h3>UserID : 
                                                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;<%=uid%></h3>			<%/*here userid is taken through session */%>
						...
						<form action="uploadServlet" method="post" name="f1" enctype="multipart/form-data">
								  ...
								  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;<select name="file_type">
									 ...
									 <option value="pdf">Pdf</option>
                                             ...
                                             &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;<input type="file" name="file_upload" ><br>
                                                     ...
                                                     <br> Comment: <br>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<textarea name="s_comment" rows="4" cols="50" placeholder="Give Your Comments Here..."></textarea><br>
                                            ...
                                            {
                                            %>
                                        <span1 class="red" >Pending Request Didn't Approve Till Now !!!</span1>
                                            <%}%>
                                           <%
                                            if(request.getAttribute("errorMessage2")!=null)
                                            {
                                            %>
                                        <span1 class="red" >Document Uploaded Successfully !!!</span1>
                                            <%}%>
                                           <%
                                            if(request.getAttribute("errorMessage3")!=null)
                                            {
                                            %>
                                           <span1 class="red" >Document Didn't Upload !!!</span1>
                                            <%}%>
                                         <%
