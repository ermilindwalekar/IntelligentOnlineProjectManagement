...
<div id="wrapper">
  ...
  <br>
                ...
                if(request.getAttribute("errorMsg1")!=null)
                 {
                 %>
                <span1 class="red" >All the projects have been stored in repository for future use & can be viewed by clicking on <a href="search_records.jsp">Search Records</a> </span1>
                 <%}%>
