		...
		<div id="content">
			...
			try {
				...
				System.out.println("connected");
							...
							PreparedStatement pst=con.prepareStatement("SELECT gid,userid,document_type,s_date,s_time,s_comment,STATUS,f_comment,f_date,f_time FROM project_details WHERE gid=?");     
							pst.setString(1, gid);
							//out.println(pst);		
